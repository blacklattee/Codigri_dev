...
${element_edit_master_product}      xpath=/html//div[@id='__next']/div[@class='MuiBox-root css-ayjhuo']//h3[.='Edit Master Product']
...
${button_edit_product}            xpath=/html//div[@id='__next']/div[@class='MuiBox-root css-ayjhuo']/div[@class='MuiBox-root css-1hwv2q0']//table[@class='MuiTable-root css-1b8n3j0']/tbody/tr[1]/td[6]/button[@type='button']
...
Create New Master Product
    ...
    Click Button                   ${button_edit_product}
    Wait Until Element Contains    ${element_edit_master_product}      Edit Master Product  
 Add New Master Product   
    #================== Page Edit Master Product ======================================
    #Wait Until Element Contains    ${element_create_master_product}    Create Master Product  
    Press Keys                      ${input_name_product}              CTRL+a BACKSPACE
    Input Text                     ${input_name_product}               Update Nike
    ...
    Press Keys                     ${descript_master_product}          CTRL+a BACKSPACE
    Input Text                     ${descript_master_product}           Test Edit Deskripsi   
